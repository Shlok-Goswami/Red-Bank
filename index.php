...
for(let i=0;i<graphscale.length;i++){
  ...
  let showscale=((i)*scale);
  if(showscale==0){

  }
  else if(showscale%1000==0){
    showscale=showscale/1000;
    showscale=(showscale.toString())+"K";
  }

  graphscale[9-i].querySelector("span").innerHTML=showscale+"";
}
...
<script src="script/home.js"></scri>
